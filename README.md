...
[SparkMvmt](https://github.com/qredwoods/exercisetracker) - [Site](https://sparkmvmt.com) - Full-stack fitness tracker that reflects progress back to the user with a dashboard for activity and personal records, and keeping sensitive data encrypted end-to-end. Built with React, Express, and MongoDB, with token-rotating JWT auth, automated backend/frontend/E2E test coverage, and production deployment on AWS through a CI/CD pipeline spanning CloudFront, S3, and an EC2 Auto Scaling backend.
